<template>
  ...
  const paginationConfig = computed(() => ({
    ...
    total: searchValue.value 
      ? lessonsData.filter(lesson => 
          lesson.subject.toLowerCase().includes(searchValue.value.toLowerCase()) ||
          lesson.class.toLowerCase().includes(searchValue.value.toLowerCase()) ||
          lesson.teacher.toLowerCase().includes(searchValue.value.toLowerCase())
        ).length
      : lessonsData.length,
  ...
  const handleView = (record) => {
    console.log('View lesson:', record);
    // View logic
  };
  
  const handleEdit = (record) => {
    console.log('Edit lesson:', record);
    // Edit logic
  };
  
  const handleDelete = (record) => {
    console.log('Delete lesson:', record);
